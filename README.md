...
```Shell
# Fast generation. The target-view video is constrained by the first and last spatial directions.  
python svg.py --prompt 'Obama is speaking' --init_image ./Videos/frame_matrix/Obama_is_speaking --output_root ./results/Obama_is_speaking/  --num_frames 16 --width 576 --height 320  --latent_w 72 --latent_h 40 --speedy_denoising --erode_size 3

# The target-view video is constrained by all spatial directions.
python svg.py --prompt 'Obama is speaking' --init_image ./Videos/frame_matrix/Obama_is_speaking --output_root ./results/Obama_is_speaking/  --num_frames 16 --width 576 --height 320  --latent_w 72 --latent_h 40 --erode_size 3
```

* __Multi-view video generation__
```Shell
python svg.py --prompt 'Obama is speaking' --init_image ./Videos/frame_matrix/Obama_is_speaking --output_root ./results/Obama_is_speaking/ --num_frames 16 --width 576 --height 320  --latent_w 72 --latent_h 40 --frame_matrix_end 0 --fix_last_view_begin 600 --erode_size 3 
```
